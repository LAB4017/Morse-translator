#include p18f87k22.inc
    ...
    global  LCD_Setup, LCD_Write_Message, LCD_clear, LCD_delay_ms, LCD_Send_Byte_D
...
LCD_Setup
	...
	movlw	.10		; wait 40us
	call	LCD_delay_x4us
	movlw	b'11000010'	;set DDRAM address - where cursor is
	call	LCD_Send_Byte_I
	movlw	.10		; wait 40us
	call	LCD_delay_x4us
	return
